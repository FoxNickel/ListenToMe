 ...
 * @since 2017-03-27
 */
public class ListenExcerciseAnswerAdapter extends RecyclerView.Adapter<ListenExcerciseAnswerAdapter.ViewHolder> {
    private final Context context;
    private List<HearingIssueBean> items;

    public ListenExcerciseAnswerAdapter(List<HearingIssueBean> items, Context context) {
        this.items = items;
