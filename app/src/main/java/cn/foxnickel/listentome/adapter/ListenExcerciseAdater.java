 ...
 * @since 2017-03-23
 */
public class ListenExcerciseAdater extends RecyclerView.Adapter<ListenExcerciseAdater.ViewHolder> {
    private Context mContext;
    private List<HearingIssueBean> mList;
    private TextView mTextView;

    public ListenExcerciseAdater(List<HearingIssueBean> items, Context context, TextView t) {
        this.mList = items;
    ...
    private void clilckEvents(final ViewHolder holder, final int position, final HearingIssueBean h) {
        holder.a_a.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ListenExcerciseActivity.hearingIssueBeen[ListenExcerciseActivity.sQuestionIndex][position].setNowAnswer('A');
                ListenExcerciseActivity.hearingIssueBeen[ListenExcerciseActivity.sQuestionIndex][position].setChecked(true);
                holder.answer_bg_a.setVisibility(View.VISIBLE);
                holder.answer_bg_c.setVisibility(View.GONE);
                holder.answer_bg_b.setVisibility(View.GONE);
                holder.answer_bg_d.setVisibility(View.GONE);
                if (holder.mCountNum[ListenExcerciseActivity.sQuestionIndex][position] == 0) {
                    holder.mCountNum[ListenExcerciseActivity.sQuestionIndex][position] = 1;
        ...
        holder.a_b.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ListenExcerciseActivity.hearingIssueBeen[ListenExcerciseActivity.sQuestionIndex][position].setNowAnswer('B');
                ListenExcerciseActivity.hearingIssueBeen[ListenExcerciseActivity.sQuestionIndex][position].setChecked(true);
                holder.answer_bg_b.setVisibility(View.VISIBLE);
                holder.answer_bg_c.setVisibility(View.GONE);
                holder.answer_bg_a.setVisibility(View.GONE);
        ...
        holder.a_c.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ListenExcerciseActivity.hearingIssueBeen[ListenExcerciseActivity.sQuestionIndex][position].setNowAnswer('C');
                ListenExcerciseActivity.hearingIssueBeen[ListenExcerciseActivity.sQuestionIndex][position].setChecked(true);
                holder.answer_bg_c.setVisibility(View.VISIBLE);
                holder.answer_bg_b.setVisibility(View.GONE);
                holder.answer_bg_a.setVisibility(View.GONE);
        ...
        holder.a_d.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ListenExcerciseActivity.hearingIssueBeen[ListenExcerciseActivity.sQuestionIndex][position].setNowAnswer('D');
                ListenExcerciseActivity.hearingIssueBeen[ListenExcerciseActivity.sQuestionIndex][position].setChecked(true);
